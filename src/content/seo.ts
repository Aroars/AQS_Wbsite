...
export const pageMetadata = {
  home: {
    title: "Packaging Line Quality Control, SCADA & Sanitary Conveyors | AQS Nampa, Idaho",
    description:
      "Your equipment catches bad product — can it prove a good one? AQS builds packaging line quality control systems that record, trace, and prove every package: VeriPak SCADA, IntelliPak feed conveyors, sanitary washdown conveyors, and hygienic robotics, engineered in Nampa, Idaho.",
  },
  solutions: {
  ...
  veripak: {
    title: "VeriPak SCADA — Checkweigher, Metal Detector & Vision Data Logging for Food Packaging Lines | AQS",
    description:
  ...
  leakDetection: {
    title: "Inline MAP Leak Detection & Seal Integrity Testing for Food Packaging | AQS",
    description:
  ...
  robotics: {
    title: "Washdown Robotic Palletizing & Case Packing — KUKA & Stäubli Hygienic Robots | AQS",
    description:
  ...
  conveyors: {
    title: "Sanitary Washdown Conveyors — Stainless Steel Food Grade Conveyor Systems | AQS",
    description:
      "Sanitary washdown conveyors for food and dairy plants: belt, MDR (24V motorized roller), and pallet conveyor systems in continuous TIG-welded 304/316 stainless steel. Flat-top, modular, incline, freezer, zero-pressure accumulation, and end-of-line pallet handling, IP69K capable.",
  },
  conveyorsBeltFamily: {
    title: "Sanitary Belt Conveyors — Flat-Top, Modular, Incline & Freezer | AQS",
    description:
      "Food grade belt conveyors in TIG-welded stainless steel: flat-top and modular belt, incline and decline with cleats, and freezer-rated arctic conveyors. FDA belting, IP69K washdown, Mag-Drive or gear motor drives.",
  },
  conveyorsMdr: {
    title: "MDR Conveyors — 24V Motorized Roller, Zero-Pressure Accumulation & Merge/Divert | AQS",
    description:
      "Washdown-rated MDR (motorized drive roller) conveyors with independent 24V zones, zero-pressure accumulation, and merge/divert routing for cases and trays. PulseRoller options, sanitary stainless frames, VeriPak integration.",
  },
  conveyorsPallet: {
    title: "Pallet Conveyors — Washdown Stainless Chain & Roller Pallet Handling | AQS",
    description:
      "Sanitary pallet conveyors for end-of-line food and dairy lines: stainless chain and roller pallet conveyance, zero-pressure pallet accumulation, dispensers, and stretch-wrapper integration. IP65 to IP69K, KUKA palletizing compatible.",
  },
  conveyorsProjects: {
  ...
  intellipak: {
    title: "IntelliPak Infeed & Collation Systems — Mag-Drive Conveyors for Packaging Lines | AQS",
    description:
  ...
  veripakLeakDetection: {
    title: "Inline MAP Leak Detection & Seal Integrity Testing — VeriPak Module | AQS",
    description:
...
// Local business structured data — the Nampa, Idaho shop (homepage)
