...
export const toolPages: ToolPage[] = [
    ...
    },
    {
        ...
        toolId: 'conveyorFlow',
        title: 'Conveyor Speed Calculator — Belt Speed (FPM) from Packages per Minute & Product Pitch | AQS Toolbox',
        description: 'Free conveyor speed calculator: belt speed in ft/min from packages per minute, product length, and gap — or solve for the rate a speed delivers or the gap it leaves. Products per foot, gap time, transit time, and belt speed from drive RPM and pulley diameter.',
    ...
    },
    {
        ...
        toolId: 'beltLoad',
        title: 'Conveyor Throughput Calculator — lb/hr to Packages per Minute & Belt Load (lb/ft) | AQS Toolbox',
        description: 'Free conveyor throughput calculator: turn a plant\'s lb/hr, lb/day, or kg/hr into packages per minute, belt speed, and belt load in lb/ft for conveyor sizing. Enter any two of throughput, package weight, and packages per minute; add product length and gap to estimate belt speed. Bulk mode sizes the bed.',
    ...
    },
    {
        ...
        toolId: 'lineFlow',
        title: 'Packaging Line Flow Simulator — Splits, Merges, Rejects & Accumulation | AQS Toolbox',
        description: 'Free packaging line flow simulator: chain an infeed through splits, merges, process dwell stations, rejects, stacking, and batching, and size accumulation buffers in feet for a given number of seconds — throughput, speed, and gap recalculated at every step.',
