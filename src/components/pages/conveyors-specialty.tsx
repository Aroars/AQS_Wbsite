...
const category = categories.find((c) => c.slug === "specialty")!;
...
export function ConveyorsSpecialtyContent() {
  return (
    <>
      {/* Hero — no approved background image yet for heavy-duty/pallet */}
      <section className="relative pt-[140px] pb-[80px] px-8 overflow-hidden">
        ...
        <div className="max-w-[1280px] mx-auto relative z-10">
          <AnimatedSection>
            <ConveyorBreadcrumb current="Heavy-Duty & Pallet" />
      ...
      <section className="pb-[72px] px-8">
        <div className="max-w-[1280px] mx-auto">
          <AnimatedSection>
            <div className="mb-6">
              <ConveyorTypeSwitcher currentCategory="specialty" />
            </div>
          </AnimatedSection>
      ...
      <section className="py-[72px] px-8 bg-black/[0.06]">
        <div className="max-w-[1280px] mx-auto">
          <AnimatedSection>
            ...
            <SectionDesc>
              Heavy-duty and pallet systems share the same sanitary construction
              standards — built to handle the heaviest loads on the line while
              maintaining full washdown capability.
            </SectionDesc>
          </AnimatedSection>
      ...
      <section className="py-[72px] px-8">
        <div className="max-w-[1280px] mx-auto">
          <AnimatedSection>
            ...
            <SectionDesc>
              Heavy-duty systems use chain-driven and gear motor configurations
              designed for maximum load capacity and reliability.
            </SectionDesc>
          </AnimatedSection>
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
            {driveTechnologies.slice(1).map((drive) => (
