...
const category = categories.find((c) => c.slug === "roller-drive")!;
...
export function ConveyorsRollerDriveContent() {
  return (
    <>
      ...
      <section className="relative pt-[140px] pb-[80px] px-8 overflow-hidden">
        ...
        <div className="max-w-[1280px] mx-auto relative z-10">
          <AnimatedSection>
            <ConveyorBreadcrumb current="Roller & Drive" />
      ...
      <section className="pb-[72px] px-8">
        <div className="max-w-[1280px] mx-auto">
          <AnimatedSection>
            <div className="mb-6">
              <ConveyorTypeSwitcher currentCategory="roller-drive" />
            </div>
          </AnimatedSection>
      ...
      <section className="py-[72px] px-8 bg-black/[0.06]">
        <div className="max-w-[1280px] mx-auto">
          <AnimatedSection>
            ...
            <SectionDesc>
              Every roller and drive system shares the same sanitary construction
              standards — continuous TIG welds, mirror-polished stainless, and
              aggressive drainage geometry.
            </SectionDesc>
          </AnimatedSection>
      ...
      <section className="py-[72px] px-8">
        <div className="max-w-[1280px] mx-auto">
          <AnimatedSection>
            ...
            <SectionDesc>
              Roller and drive systems leverage independent zone control and
              zero-pressure accumulation for intelligent traffic management.
            </SectionDesc>
          </AnimatedSection>
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-2">
            {driveTechnologies.map((drive) => (
